 ...
 * corresponding {@link java.time.format.DateTimeFormatter} string, for example, {@code yyyy-MM-dd HH:mm:ss.SSSZ}</td>
 * </tr>
 * <tr>
 ...
 * <td>empty</td>
 * <td>A map of field name replacements in the generated map. For example:
